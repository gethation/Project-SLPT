...
class MAEBackbone(vision_transformer.VisionTransformer):
    ...
    def __init__(
        ...
        self.linear_layer = nn.Linear(84, 768)

    @classmethod
    def from_vit(cls, vit: vision_transformer.VisionTransformer, out_dim) -> MAEBackbone:
        ...
        backbone.linear_layer = nn.Linear(out_dim, vit.hidden_dim)
    ...
    def images_to_tokens(
        ...
        """
        tokens = self.linear_layer(images)
